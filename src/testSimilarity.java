...
public class testSimilarity {
	...
	public static void main(String[] args) {
		...
		long [] tmp = {9112,10654,192,6218,19321,1868,7643,5724, 1497,10999,22588,11938,3785,272,8675,1824};
	
		for(int i = 0; i < tmp.length; i++) {
			a.add(tmp[i]);
		}
		
		long[] tmp2 = {129,9360,16265,9112,5831,192,5014,2142,1868,7643,1292,1497,10999,16747,7251,3785,272, 6712,1824};
